...
import { Ao as setCliSessionBinding, Cp as resolveOriginMessageProvider, Dh as routeReply, Do as runCliAgent, Dw as runWithModelFallback, Eh as isRoutableChannel, Ew as isFallbackSummaryError, Gh as queueEmbeddedPiMessage, Hm as readSessionMessages, Ik as resolvePathFromInput, Ko as resolveModelAuthMode, LI as loadCronStore, Lh as resolveBootstrapWarningSignaturesSeen, MI as resolveGroupSessionKey, Od as resolveEffectiveBlockStreamingConfig, Oh as runEmbeddedPiAgent, Oo as getCliSessionBinding, Ph as registerAgentRunContext, RI as resolveCronStorePath, Rh as LiveSessionModelSwitchError, Sh as enqueueFollowupRun, Sp as resolveOriginAccountId, Th as refreshQueuedFollowupSession, Tp as resolveRunAuthProfile, Yh as compactEmbeddedPiSession, ag as readPostCompactionContext, bp as isBunFetchSocketError, bw as parseReplyDirectives, dh as resolveFallbackTransition, dw as applyReplyThreading, eg as derivePromptTokens, f as loadConfig, fw as isRenderablePayload, gN as updateSessionStoreEntry, gh as resolveModelCostConfig, hN as updateSessionStore, hh as formatUsd, ig as estimateMessagesTokens, j_ as ensureSandboxWorkspaceForSession, jh as emitAgentEvent, jo as setCliSessionId, lN as loadSessionStore, lh as buildFallbackClearedNotice, mh as formatTokenCount, mw as resolveReplyToMode, ng as hasNonzeroUsage, ph as estimateUsageCost, pw as createReplyToModeFilterForChannel, rg as normalizeUsage, tg as deriveSessionTotalTokens, uh as buildFallbackNotice, uw as applyReplyTagsToPayload, vd as createTypingSignaler, vp as buildEmbeddedRunExecutionParams, wh as scheduleFollowupDrain, wp as resolveOriginMessageTo, xp as resolveModelFallbackOptions, yh as lookupContextTokens, yp as formatBunFetchSocketError } from "./auth-profiles-Bx_pc0K9.js";
...
import { _ as resolveRunModelFallbacksOverride, v as resolveSessionAgentId } from "./agent-scope-Cb7ofJgr.js";
import { s as isCliProvider } from "./model-selection-CcR6SGXw.js";
import { n as generateSecureUuid } from "./secure-random--MYcuPnr.js";
import { o as isInternalMessageChannel, p as resolveMessageChannel, s as isMarkdownCapableMessageChannel } from "./message-channel-BZJLUQ0u.js";
import { a as isAudioFileName } from "./mime-Di3j5FMh.js";
import { a as resolveSessionTranscriptPath, i as resolveSessionFilePathOptions, r as resolveSessionFilePath } from "./paths-DMlxK0ei.js";
import { M as resolveFreshSessionTotalTokens, _ as isSilentReplyPrefixText, g as SILENT_REPLY_TOKEN, m as stripHeartbeatToken, r as enqueueSystemEvent, v as isSilentReplyText } from "./system-events-Bwik0M7d.js";
import { n as isDiagnosticsEnabled, t as emitDiagnosticEvent } from "./diagnostic-events-XD54bcfz.js";
import { f as resolveEffectiveToolFsWorkspaceOnly } from "./web-media-BgsN6JmW.js";
import { u as resolveMemoryFlushPlan } from "./memory-state-vqwC6DF8.js";
...
import { n as resolveSandboxConfigForAgent } from "./config-TAMTTY0L.js";
import "./thinking-ChEU8iFC.js";
import { a as resolveSandboxedMediaSource, t as assertMediaNotDataUrl } from "./discord-core-di8ZeVRS.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-6D1GbjDR.js";
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-XYs0nGnP.js");
