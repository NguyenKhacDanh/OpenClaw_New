import { GE as resolveMatrixAccount, KE as resolveMatrixAccountConfig, _D as matrixSetupAdapter, _E as inspectMatrixDirectRooms, aD as resolveMatrixAuthContext, bD as updateMatrixAccountConfig, oD as setMatrixSdkConsoleLogging, sD as setMatrixSdkLogMode, uD as resolveMatrixRoomKeyBackupIssue, vE as repairMatrixDirectRooms, yD as resolveMatrixConfigPath } from "./auth-profiles-Bx_pc0K9.js";
...
import { c as getMatrixRoomKeyBackupStatus, h as restoreMatrixRoomKeyBackup, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, u as getMatrixVerificationStatus, v as verifyMatrixRecoveryKey, x as withStartedActionClient, y as withResolvedActionClient } from "./verification-CJ_XqrsW.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-X4n3Juz1.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-Dp1ylRT_.js";
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-qBQIzukn.js");
