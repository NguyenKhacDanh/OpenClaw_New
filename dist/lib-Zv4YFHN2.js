...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-DPavZoH0.js";
import { t as require_src } from "./src-VTKeYQZu.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-vud6NfD_.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-gH9qUxDe.js";
import { l as toRatio, n as decodeString } from "./Util-DcqgrydJ.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CkD6BBQ4.js";
import { a as textDecode, t as APEv2Parser } from "./APEv2Parser-CBt8e9eS.js";
import { r as hasID3v1Header } from "./ID3v1Parser-BboSjM8q.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-B6uDMXVv.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DMETNGKG.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BS7G285U.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-ImiWKadF.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DdHwmwwm.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BojHCLjo.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-BHOUb_3M.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-m8r7QfYe.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DuwW1juo.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-ePgDhcx9.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-CSIhM5Eb.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-wKJ6p4J3.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-OCzFVFWt.js")).WaveParser;
	}
};
//#endregion
