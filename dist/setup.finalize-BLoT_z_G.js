...
import { m as pathExists, v as resolveUserPath } from "./utils-ChfYK_zu.js";
import { Fp as listConfiguredWebSearchProviders } from "./auth-profiles-CbvzvUuD.js";
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-CKFBC4zU.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-CG2xBVG6.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-xRZTXO5b.js";
import { f as resolveControlUiLinks, g as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-Dp8_asbY.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-h-zaSjS4.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-BI9JBLd7.js";
...
import { t as runTui } from "./tui-C8TZaZeR.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CM3EB-u0.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CR8nUXPn.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CR8nUXPn.js");
