...
import { P as validateConfigObjectRaw, g as readConfigFileSnapshot, x as writeConfigFile } from "./auth-profiles-Bx_pc0K9.js";
import { t as CONFIG_PATH } from "./paths-DnMZ9c-4.js";
import { t as isBlockedObjectKey } from "./prototype-keys-CNhca1Bg.js";
import { n as info, o as success, t as danger } from "./globals-DcVoseYv.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-CgDJvAeW.js";
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-D6PgnNgv.js";
import { t as formatCliCommand } from "./command-format-CG2xBVG6.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-CN1JFR7j.js";
import { C as SecretProviderSchema } from "./zod-schema.core-CKUw0Kgf.js";
import { a as resolveSecretRefValue } from "./resolve-DkWre7wl.js";
import { l as discoverConfigSecretTargets, m as resolveConfigSecretTargetByPath } from "./command-secret-targets-Ltvb3Tsc.js";
import { i as redactConfigObject, n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-B7FbYCXL.js";
import { n as setCommandJsonMode } from "./json-mode-Q0oZBhdO.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-DdTzMRND.js");
