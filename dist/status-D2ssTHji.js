...
import { S as sleep, x as shortenHomePath } from "./utils-ChfYK_zu.js";
import { n as isRich, r as theme, t as colorize } from "./theme-D-TumEpz.js";
import { ZO as isGatewaySecretRefUnavailableError, l as createConfigIO, nk as trimToUndefined, rk as loadGatewayTlsRuntime } from "./auth-profiles-CbvzvUuD.js";
import { _ as resolveStateDir, o as resolveConfigPath, u as resolveGatewayPort } from "./paths-DnMZ9c-4.js";
...
import { s as isWSLEnv } from "./runtime-env-Cl5OP7LB.js";
import { t as killProcessTree } from "./kill-tree-Cjy9zdJp.js";
import { f as resolveGatewaySystemdServiceName, l as resolveGatewayLaunchAgentLabel } from "./constants-D5gU0yVR.js";
import { n as withProgress } from "./progress-UmEL-qL5.js";
import { a as inspectPortUsage, c as formatPortDiagnostics, s as classifyPortListener } from "./ports-CrHMbdrx.js";
import { _ as inspectBestEffortPrimaryTailnetIPv4, f as resolveControlUiLinks, y as resolveBestEffortGatewayBindHostForDisplay } from "./onboard-helpers-Dp8_asbY.js";
import { c as resolveGatewayLogPaths } from "./launchd-DTYsi3pu.js";
import { r as resolveGatewayService } from "./service-h-zaSjS4.js";
import { p as classifySystemdUnavailableDetail } from "./systemd-BI9JBLd7.js";
import { a as filterDaemonEnv, c as pickProbeHostForBind, d as resolveRuntimeStatusColor, f as safeDaemonEnv, o as normalizeListenerAddress, s as parsePortFromArgs, t as createCliStatusTextStyles, u as renderRuntimeHints } from "./shared-CHWBl6TP.js";
import { d as resolveDaemonContainerContext, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-CJlaMH6z.js";
...
import { i as resolveGatewayProbeAuthWithSecretInputs } from "./probe-auth-Cc4rsSyy.js";
...
async function probeGatewayStatus(opts) {
	try {
		const result = await withProgress({
			...
			if (opts.requireRpc) {
				const { callGateway } = await import("./call-D7k4QQI9.js");
				await callGateway({
					url: opts.url,
					token: opts.token,
			...
			const { probeGateway } = await import("./probe-D-I90-dx.js");
