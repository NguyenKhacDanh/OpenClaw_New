...
import { n as logError, t as logDebug } from "./logger-BxqoWWkC.js";
import { n as VERSION } from "./version-DUAVxUwB.js";
import { n as ENV_SECRET_REF_ID_RE } from "./types.secrets-D6PgnNgv.js";
import { r as getActivePluginRegistry } from "./runtime-Dyb9y8JH.js";
import { n as FILE_SECRET_REF_ID_PATTERN, r as SECRET_PROVIDER_ALIAS_PATTERN, t as EXEC_SECRET_REF_ID_JSON_SCHEMA_PATTERN } from "./ref-contract-CN1JFR7j.js";
import { t as safeParseJsonWithSchema } from "./zod-parse-C4QstAv6.js";
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES, h as GATEWAY_CLIENT_IDS } from "./message-channel-BZJLUQ0u.js";
import { a as isSecureWebSocketUrl, r as isLoopbackHost } from "./net-Dsx1u6X4.js";
import { a as signDevicePayload, i as publicKeyRawBase64UrlFromPem, n as loadOrCreateDeviceIdentity } from "./device-identity-DVlMCi3j.js";
import { n as normalizeDeviceAuthScopes, t as normalizeDeviceAuthRole } from "./device-auth-NNwVMkWJ.js";
...
const METHOD_SCOPE_GROUPS = {
	...
	[READ_SCOPE]: [
		...
		"nkd.agent.prompt",
		"nkd.workspace.soul",
		"nkd.workspace.identity",
		"nkd.workspace.agentName",
		"nkd.reports.tickets",
		"nkd.apikey.list",
		"nkd.session.list",
		"skills.status",
	...
	[ADMIN_SCOPE]: [
		"channels.logout",
		"channels.loginQrStart",
		"channels.loginQrWait",
		"nkd.kb.importText",
		"nkd.kb.upload",
		"nkd.kb.delete",
		"nkd.kb.rawDataSave",
		"nkd.kb.syncWorkspace",
		"nkd.kb.fixPdfRaw",
		"nkd.agent.profileSave",
		"nkd.agent.promptSave",
		"nkd.workspace.soulSave",
		"nkd.workspace.identitySave",
		"nkd.gateway.restart",
		"nkd.apikey.set",
		"nkd.apikey.delete",
		"nkd.session.clearAll",
		"nkd.session.clear",
		"agents.create",
		"agents.update",
		"agents.delete",
