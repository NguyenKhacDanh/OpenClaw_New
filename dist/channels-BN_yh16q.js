...
import { Ds as applyPluginAutoEnable, Em as formatUsageReportLines, MA as createMessageActionDiscoveryContext, NA as resolveMessageActionDiscoveryForPlugin, Sw as resolveCommandSecretRefsViaGateway, Tm as loadProviderUsageSummary, UO as callGateway, f as loadConfig, g as readConfigFileSnapshot, vw as resolveMessageChannelSelection, x as writeConfigFile } from "./auth-profiles-CbvzvUuD.js";
import { r as loadAuthProfileStore } from "./store-hq9aamNS.js";
import { _ as normalizeAccountId } from "./session-key-B-JhgBEk.js";
import { t as danger } from "./globals-DcVoseYv.js";
import { m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-Cb7ofJgr.js";
import { t as formatCliCommand } from "./command-format-CG2xBVG6.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-Di_fPjeK.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-BCTVwbQ6.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BNOJE4r3.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-DCRHwb27.js";
...
import { r as listChannelPluginCatalogEntries } from "./catalog-CBOKLxRK.js";
import { t as createClackPrompter } from "./clack-prompter-BQ43Z69d.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-BBaAI2nj.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-QAgjVYpF.js";
import { t as parseLogLine } from "./parse-log-line-2NyvcTVn.js";
import { i as describeBinding, n as applyAgentBindings, t as requireValidConfigSnapshot } from "./config-validation-ORrWYue_.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-CILNjGWI.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-CHXDX9lS.js"), import("./onboard-channels-BILfWA4X.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-CCMVQclw.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-CCMVQclw.js");
			const prompter = createClackPrompter();
