import { g as resolveHomeDir, u as isRecord } from "./utils-ChfYK_zu.js";
import { L as OpenClawSchema, g as readConfigFileSnapshot } from "./auth-profiles-Bx_pc0K9.js";
import { t as CONFIG_PATH } from "./paths-DnMZ9c-4.js";
import { n as formatConfigIssueLines } from "./issue-format-CgDJvAeW.js";
import { t as note } from "./note-BCZGGxvP.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BeizSm4w.js");
