...
import { g as readConfigFileSnapshot, nL as logConfigUpdated, x as writeConfigFile } from "./auth-profiles-CbvzvUuD.js";
import { u as resolveGatewayPort } from "./paths-DnMZ9c-4.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-D6PgnNgv.js";
...
import "./daemon-runtime-DVTfAxiC.js";
import { c as normalizeGatewayTokenInput, d as randomToken, f as resolveControlUiLinks, g as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-Dp8_asbY.js";
import { t as createClackPrompter } from "./clack-prompter-BQ43Z69d.js";
import { t as runSetupWizard } from "./setup-DA1e5Xx0.js";
import { a as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-BrAFS-GQ.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-CcSN4i6D.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-BtSAWGpT.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-BejnWaNI.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-gzvZe6Iu.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-6h7Xn_u4.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Cj2jnObQ.js");
