...
import { g as readConfigFileSnapshot, nL as logConfigUpdated, x as writeConfigFile } from "./auth-profiles-Bx_pc0K9.js";
...
import { c as normalizeGatewayTokenInput, d as randomToken, f as resolveControlUiLinks, g as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-DU-QKVxu.js";
import { t as createClackPrompter } from "./clack-prompter-BQ43Z69d.js";
import { t as runSetupWizard } from "./setup-CgVQDBiI.js";
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DD32VZgJ.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BLeXS6zf.js");
