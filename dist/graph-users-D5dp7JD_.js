...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-C1_p5SOF.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-BnoIzb8w.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createBotFrameworkJwtValidator(creds) {
	const { createServiceTokenValidator } = await import("./jwt-validator-O99OOuzK.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
