...
import { T as truncateUtf16Safe, v as resolveUserPath } from "./utils-ChfYK_zu.js";
import { fg as onSessionTranscriptUpdate } from "./auth-profiles-CbvzvUuD.js";
...
import { i as listMemoryEmbeddingProviders, n as getMemoryEmbeddingProvider, t as resolveMemorySearchConfig } from "./memory-search-BRuaXbHY.js";
import { i as getMemoryMultimodalExtensions, r as classifyMemoryMultimodalPath, t as buildCaseInsensitiveExtensionGlob } from "./multimodal-E37cp3BY.js";
import { t as extractKeywords } from "./query-expansion-CcFqhKPk.js";
import "./memory-core-host-engine-foundation-DR_5rmpj.js";
import { _ as estimateUtf8Bytes, a as ensureDir, c as listMemoryFiles, d as remapChunkLines, f as runWithConcurrency, g as estimateStructuredEmbeddingInputBytes, h as hasNonTextEmbeddingParts, i as cosineSimilarity, l as normalizeExtraMemoryPaths, n as buildMultimodalChunkForIndexing, o as hashText, p as isFileMissingError, r as chunkMarkdown, t as buildFileEntry, u as parseEmbedding } from "./internal-_iuS2Wfg.js";
import { c as listSessionFilesForAgent, l as sessionPathForFile, s as buildSessionEntry } from "./memory-core-host-engine-qmd-3_I6oTVB.js";
import { r as readMemoryFile } from "./backend-config-DbASjwrv.js";
import { n as loadSqliteVecExtension, r as ensureMemoryIndexSchema, t as requireNodeSqlite } from "./memory-core-host-engine-storage-CoFIbYpb.js";
import { a as runGeminiEmbeddingBatches, c as DEFAULT_VOYAGE_EMBEDDING_MODEL, d as createOpenAiEmbeddingProvider, f as DEFAULT_MISTRAL_EMBEDDING_MODEL, g as createGeminiEmbeddingProvider, h as buildGeminiEmbeddingRequest, i as runOpenAiEmbeddingBatches, l as createVoyageEmbeddingProvider, m as DEFAULT_GEMINI_EMBEDDING_MODEL, n as runVoyageEmbeddingBatches, o as DEFAULT_LOCAL_MODEL, p as createMistralEmbeddingProvider, r as OPENAI_BATCH_ENDPOINT, s as createLocalEmbeddingProvider, t as enforceEmbeddingMaxInputTokens, u as DEFAULT_OPENAI_EMBEDDING_MODEL } from "./memory-core-host-engine-embeddings-RsIT1m-1.js";
import { n as createOllamaEmbeddingProvider, t as DEFAULT_OLLAMA_EMBEDDING_MODEL } from "./embedding-provider-kayhcvpT.js";
