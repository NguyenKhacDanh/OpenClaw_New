import { $p as countPendingDescendantRuns, CT as sanitizeTextContent, GT as looksLikeSessionId, HT as resolveInternalSessionKey, Jp as formatRunStatus, UO as callGateway, UT as resolveMainSessionAlias, VS as parseTelegramTarget, VT as extractTextFromChatContent, WT as SESSION_ID_RE, Yp as resolveSubagentTargetFromRuns, _d as resolveEffectiveResetTargetSessionKey, gd as resolveConversationBindingThreadIdFromMessage, hd as resolveConversationBindingContextFromAcpCommand, lm as resolveStoredSubagentCapabilities, md as resolveConversationBindingChannelFromMessage, pd as resolveConversationBindingAccountIdFromMessage, qp as formatRunLabel } from "./auth-profiles-CbvzvUuD.js";
import { T as parseAgentSessionKey, c as normalizeAgentId, w as isSubagentSessionKey } from "./session-key-B-JhgBEk.js";
import { o as formatTimeAgo } from "./account-summary-GdhmAYfp.js";
import { a as normalizeConversationText } from "./telegram-core-C9d2tm-O.js";
import { i as parseExplicitTargetForChannel } from "./reply-payloads-dedupe-DmrsC7on.js";
import { h as supportsAutomaticThreadBindingSpawn } from "./thread-bindings-runtime-CgSwznh1.js";
import { n as toAcpRuntimeErrorText } from "./error-text-ccoDPkTq.js";
