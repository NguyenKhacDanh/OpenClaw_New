...
if (!isMainModule({
	...
	const { installGaxiosFetchCompat } = await import("./gaxios-fetch-compat-5gTvQQcz.js");
	...
	function tryHandleRootVersionFastPath(argv) {
		...
		Promise.all([import("./version-BPbrmyC7.js"), import("./git-commit-D2eg67VN.js")]).then(([{ VERSION }, { resolveCommitHash }]) => {
