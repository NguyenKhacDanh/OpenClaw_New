import { A as TtsConfigSchema } from "./zod-schema.core-CKUw0Kgf.js";
...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-CcWfy00z.js";
import { t as zod_exports } from "./zod-C2BGnibp.js";
import "./api-DD10n5b-.js";
  ...
  <Play loop="0">https://s3.amazonaws.com/com.twilio.music.classical/BusyStrings.mp3</Play>
	...
	*/
	async handleInboundResponse(callId, userMessage) {
		...
		try {
			const { generateVoiceResponse } = await import("./response-generator-DaAY_kUm.js");
