...
import { $I as updateConfig, AA as discoverModels, Bf as resolveAuthProfileEligibility, EA as resolveModelWithRegistry, Es as resolvePluginProviders, GI as formatTokenK, Go as resolveApiKeyForProvider, HI as applyDefaultModelPrimaryUpdate, Ho as getCustomProviderApiKey, JI as mergePrimaryFallbackConfig, KI as isLocalBaseUrl, LP as loadModelCatalog, Oh as runEmbeddedPiAgent, Om as formatUsageWindowSummary, Pw as describeFailoverError, QI as resolveModelTarget, Sw as resolveCommandSecretRefsViaGateway, Tm as loadProviderUsageSummary, UI as ensureFlagCompatibility, Uf as clearAuthProfileCooldown, Vf as resolveAuthProfileOrder, WI as formatMs, WL as resolveAuthProfileDisplayLabel, Wo as hasUsableCustomProviderApiKey, XI as resolveKnownAgentId, Xf as resolveProfileUnusableUntilForDisplay, YI as normalizeAlias, ZI as resolveModelKeysFromEntries, _ as readConfigFileSnapshotForWrite, eL as upsertCanonicalModelConfigEntry, f as loadConfig, jA as shouldSuppressBuiltInModel, kA as discoverAuthStorage, l as createConfigIO, nL as logConfigUpdated, qI as loadValidConfigOrThrow, qo as resolveUsableCustomProviderApiKey, y as setRuntimeConfigSnapshot } from "./auth-profiles-CbvzvUuD.js";
import { d as resolveAuthStorePathForDisplay, i as loadAuthProfileStoreForRuntime, n as ensureAuthProfileStore, p as resolveOpenClawAgentDir } from "./store-hq9aamNS.js";
...
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir, s as resolveAgentExplicitModelPrimary, u as resolveAgentModelFallbacksOverride } from "./agent-scope-Cb7ofJgr.js";
import { g as resolveDefaultAgentWorkspaceDir } from "./workspace-CKFBC4zU.js";
import { f as parseModelRef, g as resolveDefaultModelForAgent, h as resolveConfiguredModelRef, i as buildModelAliasIndex, l as modelKey, s as isCliProvider, v as resolveModelRefFromString } from "./model-selection-CcR6SGXw.js";
import { d as isNonSecretApiKeyMarker, t as resolveEnvApiKey, w as shouldEnableShellEnvFallback, y as getShellEnvAppliedKeys } from "./model-auth-env-y2P3WJXi.js";
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-D6PgnNgv.js";
import { t as formatCliCommand } from "./command-format-CG2xBVG6.js";
import { t as parseDurationMs } from "./parse-duration-DBUS0Leh.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-DMlxK0ei.js";
import { i as resolveSecretRefString } from "./resolve-DkWre7wl.js";
import { a as upsertAuthProfile, i as setAuthProfileOrder, n as listProfilesForProvider } from "./profiles-v816nime.js";
import { r as resolveAwsSdkEnvVarName } from "./provider-auth-runtime-BMlzekcE.js";
import { r as getModelsCommandSecretTargetIds } from "./command-secret-targets-Ltvb3Tsc.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-BUlirFBU.js";
import { r as withProgressTotals } from "./progress-UmEL-qL5.js";
import { m as resolveUsageProviderId } from "./provider-usage.fetch-_JnEyLTE.js";
import { n as openUrl } from "./browser-open-xRZTXO5b.js";
import "./onboard-helpers-Dp8_asbY.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-C7Uz_3ig.js";
import "./provider-auth-login-DmaBvKQa.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-lNhhV-Jg.js";
import { t as maskApiKey } from "./mask-api-key-C7tWrFUr.js";
import { t as createClackPrompter } from "./clack-prompter-BQ43Z69d.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-BVb7TDXR.js";
import { a as isRemoteEnvironment, i as resolveProviderMatch, n as mergeConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-BD7A2yoF.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-B-ejbswv.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-CFVnVfFQ.js";
import { n as redactSecrets } from "./format-Dljvs4HG.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-B93ecAci.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureOpenClawModelsJson } = await import("./models-config-CLNwsDmH.js");
