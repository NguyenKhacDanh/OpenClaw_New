import { Bk as resolveMergedSafeBinProfileFixtures, Rk as listInterpreterLikeSafeBins, Wv as redactCdpUrl, Yk as normalizeTrustedSafeBinDirs, aA as listRiskyConfiguredSafeBins, cy as resolveProfile, fk as isInterpreterLikeAllowlistPattern, my as resolveBrowserControlAuth, ob as resolveGatewayAuth, sy as resolveBrowserConfig, vk as loadExecApprovals } from "./auth-profiles-CbvzvUuD.js";
import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-DnMZ9c-4.js";
import { t as DEFAULT_AGENT_ID } from "./session-key-B-JhgBEk.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-D6PgnNgv.js";
import { t as formatCliCommand } from "./command-format-CG2xBVG6.js";
import { n as hasPotentialConfiguredChannels } from "./config-presence-Cq1DYtWL.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-DcASjL35.js";
import { l as isPrivateNetworkAllowedByPolicy, s as isBlockedHostnameOrIp } from "./ssrf-DyWPQUCV.js";
import { n as resolveSandboxConfigForAgent } from "./config-TAMTTY0L.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-DcZyY0bu.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-DKqSh7Rw.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-f6HD1_H2.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-ZlG9_DVJ.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-i0zVRu54.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-Dt4KKOoo.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-D7k4QQI9.js"),
		import("./probe-auth-CDMDsWnk.js"),
		import("./probe-D-I90-dx.js")
