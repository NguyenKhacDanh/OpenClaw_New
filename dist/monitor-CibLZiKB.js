import { $E as releaseSharedClientInstance, EE as MATRIX_REACTION_EVENT_TYPE, FE as isPollEventType, GE as resolveMatrixAccount, ID as ensureConfiguredAcpBindingReady, IE as isPollStartType, KE as resolveMatrixAccountConfig, LD as resolveConfiguredAcpBindingRecord, NE as formatPollAsText, OE as extractMatrixReactionAnnotation, Oj as formatLocationText, RE as parsePollStartContent, SE as readJoinedMatrixMembers, UE as resolveConfiguredMatrixBotUserIds, VE as resolveMatrixTargets, _E as inspectMatrixDirectRooms, aD as resolveMatrixAuthContext, bD as updateMatrixAccountConfig, bE as isStrictDirectMembership, bP as getSessionBindingService, cD as LogService, dE as reactMatrixMessage, eD as resolveSharedMatrixClient, fE as sendMessageMatrix, hD as isBunRuntime, hE as sendTypingMatrix, iD as resolveMatrixAuth, kj as toLocationContext, lD as createAsyncLock, mE as sendReadReceiptMatrix, nD as resolveMatrixStateFilePath, rD as resolveMatrixStoragePaths, uE as createMatrixThreadBindingManager, wE as setActiveMatrixClient, xE as isStrictDirectRoom, yE as hasDirectMatrixMemberFlag } from "./auth-profiles-Bx_pc0K9.js";
...
import { n as formatAllowlistMatchMeta } from "./allowlist-match-y63mSJ7R.js";
...
import { c as buildAllowlistResolutionSummary, d as patchAllowlistUsersInConfigEntries, f as summarizeMapping, l as canonicalizeAllowlistWithResolvedIds, s as addAllowlistUserEntriesFromConfigEntry } from "./allow-from-E6eVZuju.js";
import { c as getAgentScopedMediaLocalRoots } from "./web-media-BgsN6JmW.js";
import { n as createTypingCallbacks, o as createReplyPrefixOptions } from "./channel-reply-pipeline-CxDxu1Px.js";
...
import { n as getMatrixRuntime } from "./runtime-api-Rfux9Qmv.js";
import { i as resolveMatrixRoomConfig, n as normalizeMatrixUserId, r as resolveMatrixAllowListMatch, t as normalizeMatrixAllowList } from "./allowlist-DTs7RXIG.js";
import { n as summarizeMatrixDeviceHealth } from "./device-health-X4n3Juz1.js";
import { t as syncMatrixOwnProfile } from "./profile-DBbgu4SH.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-B-0quAsd.js";
import { a as formatMatrixMessageText, i as formatMatrixMediaUnavailableText, n as fetchMatrixPollSnapshot, o as resolveMatrixMessageAttachment, s as resolveMatrixMessageBody } from "./poll-summary-C1eghIAP.js";
