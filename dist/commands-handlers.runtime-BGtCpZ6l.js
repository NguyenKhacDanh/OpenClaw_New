import { i as clampInt, v as resolveUserPath } from "./utils-ChfYK_zu.js";
import { $D as validateRuntimeModeInput, $h as mapThinkingLevel, $p as countPendingDescendantRuns, A as setConfigValueAtPath, AA as discoverModels, Ag as isTtsProviderConfigured, Bb as executePluginCommand, Bg as setTtsEnabled, Bh as abortEmbeddedPiRun, Bp as killControlledSubagentRun, Cd as resolveAbortCutoffFromContext, Ch as clearSessionQueues, D as unsetConfigOverride, Dg as getTtsProvider, E as setConfigOverride, EA as resolveModelWithRegistry, Eg as getTtsMaxLength, Fg as resolveTtsPrefsPath, GC as parseActivationCommand, GD as resolveSessionStorePathForAcp, Gp as steerControlledSubagentRun, Gx as isTelegramExecApprovalClientEnabled, Hb as matchPluginCommand, Hg as setTtsProvider, Hh as getActiveEmbeddedRunSnapshot, Hp as listControlledSubagentRuns, I as validateConfigObjectWithPlugins, JD as requireAcpRuntimeBackend, Jh as resolveFastModeState, KD as getAcpRuntimeBackend, Kp as formatDurationCompact, Kw as triggerOpenClawRestart, Lg as setLastTtsAttempt, Lj as isAbortTrigger, O as getConfigValueAtPath, Og as isSummarizationEnabled, Pg as resolveTtsConfig, QD as validateRuntimeCwdInput, Rg as setSummarizationEnabled, Rj as setAbortMemory, Rp as buildSubagentList, T as resetConfigOverrides, Td as formatElevatedUnavailableMessage, Tg as getResolvedSpeechProviderConfig, UD as getAcpSessionManager, UO as callGateway, Uh as isEmbeddedPiRunActive, Uw as scheduleGatewaySigusr1Restart, VP as ensureOpenClawModelsJson, Vg as setTtsMaxLength, Vo as getApiKeyForModel, WD as readAcpSessionEntry, Wg as textToSpeech, Wp as sendControlledSubagentMessage, Wx as isTelegramExecApprovalApprover, XD as parseRuntimeTimeoutSecondsInput, Xp as sortSubagentRuns, Yh as compactEmbeddedPiSession, ZD as validateRuntimeConfigOptionInput, Zp as spawnSubagentDirect, _O as createExecTool, __ as canonicalizeSpeechProviderId, _m as isAcpEnabledByPolicy, ap as rejectNonOwnerCommand, bP as getSessionBindingService, bm as resolveAcpDispatchPolicyMessage, cd as formatAbortReplyText, ch as formatTokenCount, cp as requireGatewayClientScopeForInternalChannel, dO as resolveThreadBindingIntroText, dp as handleContextCommand, eI as diag, eO as validateRuntimeModelInput, fO as resolveThreadBindingThreadName, fp as handleExportSessionCommand, g as readConfigFileSnapshot, gg as unsetConfiguredMcpServer, gm as resolveAcpThreadSessionDetailLines, gp as handleWhoamiCommand, hN as updateSessionStore, hg as setConfiguredMcpServer, hh as formatUsd, hm as resolveAcpSessionIdentifierLinesFromIdentity, ho as isDiscordExecApprovalClientEnabled, hp as handleToolsCommand, ip as buildDisabledCommandReply, j as unsetConfigValueAtPath, k as parseConfigPath, kA as discoverAuthStorage, kg as isTtsEnabled, kh as EmbeddedBlockChunker, lN as loadSessionStore, lO as formatThreadBindingDurationLabel, ld as resolveSessionEntryForKey, lg as stripToolResultDetails, mg as listConfiguredMcpServers, mh as formatTokenCount$1, mk as getSession, mm as resolveAcpSessionCwd, mo as isDiscordExecApprovalApprover, mp as handleStatusCommand, nO as resolveAcpSessionResolutionError, np as handleModelsCommand, od as extractBtwQuestion, op as rejectUnauthorizedCommand, pk as getFinishedSession, pm as resolveAcpSpawnRuntimePolicyError, pp as handleHelpCommand, qh as waitForEmbeddedPiRunEnd, qp as formatRunLabel, sO as toAcpRuntimeError, sh as formatContextUsageShort, sp as requireCommandFlagEnabled, tO as validateRuntimePermissionProfileInput, ud as stopSubagentsForRequester, up as handleCommandsListCommand, v_ as getSpeechProvider, vm as resolveAcpAgentPolicyError, w as getConfigOverrides, wT as stripToolMessages, wd as shouldPersistAbortCutoff, wg as getLastTtsAttempt, x as writeConfigFile, xd as applyAbortCutoffToSessionEntry, xm as cleanupFailedAcpSpawn, y_ as listSpeechProviders, ym as resolveAcpDispatchPolicyError, zf as resolveSessionAuthProfileOverride, zp as killAllControlledSubagentRuns } from "./auth-profiles-Bx_pc0K9.js";
import { d as normalizeUsageDisplay, p as resolveResponseUsageMode, s as normalizeFastMode } from "./thinking.shared-CA9NbpNW.js";
import { _ as normalizeAccountId, v as normalizeOptionalAccountId } from "./session-key-B-JhgBEk.js";
import { r as logVerbose } from "./globals-DcVoseYv.js";
...
import { a as normalizeChannelId } from "./registry-CYKflEtU.js";
import { t as clearPluginManifestRegistryCache } from "./manifest-registry-DqyqAJbg.js";
import { t as resolveAccountEntry } from "./account-lookup-Dkikb73g.js";
import { t as getChannelPlugin } from "./plugins-BNOJE4r3.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-L_-z3h2o.js";
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES, o as isInternalMessageChannel } from "./message-channel-BZJLUQ0u.js";
import { t as parseDurationMs } from "./parse-duration-DBUS0Leh.js";
import { i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-DMlxK0ei.js";
import { r as isRestartEnabled, t as isCommandFlagEnabled } from "./commands-rTcHAK78.js";
import { M as resolveFreshSessionTotalTokens, r as enqueueSystemEvent } from "./system-events-Bwik0M7d.js";
import { n as requireApiKey } from "./provider-auth-runtime-DI_eiPv5.js";
import { n as createInternalHookEvent, p as triggerInternalHook } from "./internal-hooks-pLf-XDY_.js";
import { K as resolveSandboxRuntimeStatus } from "./reply-payloads-dedupe-DmrsC7on.js";
import "./thinking-ChEU8iFC.js";
import { a as resolveArchiveKind } from "./archive-CgzjEb4L.js";
import { _ as stripStructuralPrefixes, g as stripMentions } from "./reply-history-DgDnhohn.js";
import { p as normalizeCommandBody } from "./commands-registry-BbYPv-yi.js";
import { ln as ErrorCodes } from "./method-scopes-BpaylMXX.js";
import { a as requiresNativeThreadContextForThreadHere, c as resolveThreadBindingIdleTimeoutMsForChannel, d as resolveThreadBindingMaxAgeMsForChannel, f as resolveThreadBindingPlacementForCurrentContext, i as formatThreadBindingSpawnDisabledError, p as resolveThreadBindingSpawnPolicy, r as formatThreadBindingDisabledError } from "./thread-bindings-runtime-CgSwznh1.js";
import { n as createPluginRuntime } from "./runtime-nbzOWFjv.js";
import { n as setPluginEnabledInConfig } from "./enable-Czce8YV3.js";
import { n as incrementCompactionCount } from "./session-updates-BkCisD6m.js";
import { A as resolveAcpCommandBindingContext, B as resolveDisplayStatus, C as resolveAcpHelpText, D as resolveAcpInstallCommandHint, E as withAcpCommandErrorBoundary, F as formatLogLines, G as resolveSubagentsAction, H as resolveHandledPrefix, I as formatTimestampWithAge, J as isDiscordSurface, K as stopWithText$1, L as loadSubagentSessionEntry, M as resolveAcpCommandThreadId, O as resolveConfiguredAcpBackendId, P as buildSubagentsHelp, Q as resolveCommandSurfaceChannel, R as resolveCommandSubagentController, S as resolveAcpAction, T as stopWithText, U as resolveRequesterSessionKey, V as resolveFocusTargetSession, W as resolveSubagentEntryForToken, X as isTelegramSurface, Y as isMatrixSurface, Z as resolveChannelAccountId, _ as parseOptionalSingleTarget, a as ACP_INSTALL_USAGE, b as parseSpawnInput, c as ACP_RESET_OPTIONS_USAGE, d as ACP_STATUS_USAGE, f as ACP_TIMEOUT_USAGE, g as formatRuntimeOptionsText, h as formatAcpCapabilitiesText, i as ACP_DOCTOR_USAGE, j as resolveAcpCommandConversationId, k as resolveAcpCommandAccountId, l as ACP_SESSIONS_USAGE, m as collectAcpErrorText, n as resolveBoundAcpThreadSessionKey, o as ACP_MODEL_USAGE, p as COMMAND, q as resolveTelegramConversationId, r as ACP_CWD_USAGE, s as ACP_PERMISSIONS_USAGE, t as resolveAcpTargetSessionKey, u as ACP_SET_MODE_USAGE, v as parseSetCommandInput, w as resolveCommandRequestId, x as parseSteerInput, y as parseSingleValueCommandInput, z as resolveDiscordChannelIdForFocus } from "./targets-CgwiWcVw.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-BjC5tShH.js";
import { t as parseConfigValue } from "./config-value-CUDn8SEz.js";
import { i as buildNpmInstallRecordFields, n as persistPluginInstall } from "./plugins-install-persist-BCpA8eru.js";
import { s as parseClawHubPluginSpec } from "./clawhub-B9hCAbkH.js";
import { i as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-CziyxoWj.js";
import { r as installPluginFromClawHub } from "./clawhub-BeYltB99.js";
import { a as buildPluginStatusReport, i as buildPluginInspectReport, o as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-DmH0YdUo.js";
import { a as decidePreferredClawHubFallback, f as resolveFileNpmSpecToLocalPath, i as createPluginInstallLogger, n as buildPreferredClawHubSpec } from "./plugins-command-helpers-CficodaJ.js";
import { n as loadCostUsageSummary, r as loadSessionCostSummary } from "./session-cost-usage-BujA0mW6.js";
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-CC3f9GMC.js");
		killProcessTree(pid);
