...
import { l as escapeRegExp } from "./utils-ChfYK_zu.js";
import { $F as resolveTextChunkLimit, $c as resolveThreadBindingIdleTimeoutMs, $s as sendPollWhatsApp, Ab as CommandLane, Aw as listRuntimeImageGenerationProviders, BI as resolveMarkdownTableMode, Bj as formatInboundEnvelope, CC as signalMessageActions, DM as recordChannelActivity, EM as getChannelActivity, Fb as setTelegramThreadBindingIdleTimeoutBySessionKey, Fd as createReplyDispatcherWithTyping, Fj as shouldComputeCommandAuthorized, HF as convertMarkdownTables, Hc as setThreadBindingIdleTimeoutBySessionKey, Hj as resolveEnvelopeFormatOptions, Hs as loginWeb, Ib as setTelegramThreadBindingMaxAgeBySessionKey, Ip as listWebSearchProviders, JF as chunkMarkdownText, Jc as getThreadBindingManager, Js as readWebSelfId, KM as probeLineBot, Lp as runWebSearch, Ls as getWebAuthAgeMs, Mj as hasControlCommand, Nd as withReplyDispatcher, Nh as onAgentEvent, Pj as isControlCommandMessage, Ps as getActiveWebListener, QF as resolveChunkMode, QM as dispatchReplyFromConfig, Qs as sendMessageWhatsApp, Rs as handleWhatsAppAction, TM as resolveIndicatorType, Uc as setThreadBindingMaxAgeBySessionKey, Us as logoutWeb, Vs as logWebSelfId, Wc as unbindThreadBindingsBySessionKey, Ws as monitorWebChannel, XF as chunkText, Xj as resolveInboundDebounceMs, YF as chunkMarkdownTextWithMode, Yj as createInboundDebouncer, ZF as chunkTextWithMode, _C as recordInboundSession, _M as resolveDefaultLineAccountId, aF as saveMediaBuffer, ac as loadPluginBoundaryModuleWithJiti, ak as areHeartbeatsEnabled, bM as resolveHeartbeatVisibility, cC as monitorSignalProvider, cM as pushMessagesLine, cO as resolveAgentTimeoutMs, dN as recordSessionMetaFromInbound, eC as resolveTelegramToken, eM as createQuickReplyItems, el as resolveThreadBindingInactivityExpiresAt, f as loadConfig, fM as sendMessageLine, fd as getReplyFromConfig, fg as onSessionTranscriptUpdate, fi as sendMessageIMessage, gM as normalizeAccountId, hM as listLineAccountIds, hN as updateSessionStore, iM as pushFlexMessage, ic as webAuthExists, id as dispatchReplyWithBufferedBlockDispatcher, jM as buildTemplateMessageFromPayload, kd as resolveHeartbeatReplyPayload, ks as createRuntimeWhatsAppLoginTool, kw as generateImage, lC as sendMessageSignal, lM as pushTemplateMessage, lN as loadSessionStore, lk as resolveHeartbeatReasonKind, mN as updateLastRoute, nl as resolveThreadBindingMaxAgeMs, nw as resolveHeartbeatDeliveryTarget, oC as probeSignal, oM as pushLocationMessage, oc as resolvePluginRuntimeModulePath, ok as requestHeartbeatNow, ol as discordMessageActions, ow as buildOutboundSessionContext, pN as saveSessionStore, pi as probeIMessage, qF as chunkByNewline, qb as telegramMessageActions, rc as waitForWebLogin, rw as resolveHeartbeatSenderContext, sM as pushMessageLine, sc as resolvePluginRuntimeRecord, sk as setHeartbeatWakeHandler, sw as deliverOutboundPayloads, tc as startWebLoginWithQr, tf as monitorLineProvider, tl as resolveThreadBindingMaxAgeExpiresAt, uM as pushTextMessageWithQuickReplies, uN as readSessionUpdatedAt, ui as monitorIMessageProvider, vL as appendCronStyleCurrentTimeLine, vM as resolveLineAccount, wb as getQueueSize, x as writeConfigFile, xF as isVoiceCompatibleAudio, xI as resolveSessionResetPolicy, xM as emitHeartbeatEvent, xg as clearBootstrapSnapshotOnSessionRollover, yI as evaluateSessionFreshness, zj as formatAgentEnvelope } from "./auth-profiles-Bx_pc0K9.js";
...
import { T as parseAgentSessionKey, c as normalizeAgentId, h as toAgentStoreSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-B-JhgBEk.js";
import { a as shouldLogVerbose } from "./globals-DcVoseYv.js";
import { a as resolveAgentDir, i as resolveAgentConfig, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-Cb7ofJgr.js";
import { a as logWarn } from "./logger-BxqoWWkC.js";
import { n as runCommandWithTimeout } from "./exec-DSvHEDD0.js";
import { d as ensureAgentWorkspace, i as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-CKFBC4zU.js";
import { S as resolveThinkingDefault } from "./model-selection-CcR6SGXw.js";
import { n as VERSION } from "./version-DUAVxUwB.js";
import { a as resolveAgentRoute, n as buildAgentSessionKey } from "./base-session-key-NgoBW9Up.js";
import { i as buildPairingReply } from "./channel-pairing-CMuqpAgA.js";
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./channel-policy-CZapjgwh.js";
import { l as resolveCommandAuthorizedFromAuthorizers } from "./dm-policy-shared-D9Rt9w-c.js";
import { t as getChannelPlugin } from "./plugins-BNOJE4r3.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-L_-z3h2o.js";
import { a as createLazyRuntimeSurface, n as createLazyRuntimeMethodBinder, r as createLazyRuntimeModule, t as createLazyRuntimeMethod } from "./lazy-runtime-nIDZwrs-.js";
import { i as resolveUserTimezone } from "./date-time-Md5FjnVx.js";
import { i as resolveHumanDelayConfig, n as resolveAgentIdentity, r as resolveEffectiveMessagesConfig } from "./identity-CYcjYQwp.js";
import { m as mediaKindFromMime, t as detectMime } from "./mime-Di3j5FMh.js";
import { c as resizeToJpeg, i as getImageMetadata } from "./image-ops-BCSVJtvR.js";
import { l as resolveStorePath, r as resolveSessionFilePath } from "./paths-DMlxK0ei.js";
import { n as shouldAckReaction, t as removeAckReactionAfterReply } from "./ack-reactions-BiPKN1m8.js";
import { t as finalizeInboundContext } from "./inbound-context-Cm4_-Y_H.js";
import { n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-VO-PbcmU.js";
import { f as isHeartbeatContentEffectivelyEmpty, h as HEARTBEAT_TOKEN, l as resolveSystemEventDeliveryContext, m as stripHeartbeatToken, o as peekSystemEventEntries, p as resolveHeartbeatPrompt$1, r as enqueueSystemEvent } from "./system-events-Bwik0M7d.js";
...
import { f as buildMentionRegexes, m as matchesMentionWithExplicit, p as matchesMentionPatterns } from "./reply-history-DgDnhohn.js";
import { y as shouldHandleTextCommands } from "./commands-registry-BbYPv-yi.js";
import { n as collectTelegramUnmentionedGroupIds } from "./audit-BgEqadr1.js";
import "./line-runtime-D0rmbaSr.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-CiuAhKp5.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("./runtime-embedded-pi.runtime-D29KfWz0.js"));
...
const bindDiscordRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-discord-ops.runtime-DlUM9rz0.js"), ({ runtimeDiscordOps }) => runtimeDiscordOps));
...
const bindSlackRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-slack-ops.runtime-DqYY9NTW.js"), ({ runtimeSlackOps }) => runtimeSlackOps));
...
const bindTelegramRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-telegram-ops.runtime-DS84dLQb.js"), ({ runtimeTelegramOps }) => runtimeTelegramOps));
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("./runtime-tts.runtime-BU9iT1hb.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-media-understanding.runtime-DIYMdxBZ.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime-H3qQqlJM.js"));
