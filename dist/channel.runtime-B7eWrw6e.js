...
import "./accounts-Cq_k6q6q.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-CfbttO-h.js";
import { t as sendMessageZalo } from "./send-fqsZca4s.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Baxq1hFa.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-DFo91pKH.js");
