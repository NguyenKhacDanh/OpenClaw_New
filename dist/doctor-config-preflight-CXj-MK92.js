...
import { L as OpenClawSchema, g as readConfigFileSnapshot } from "./auth-profiles-CbvzvUuD.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-DXycFfAd.js");
