...
import { o as stripChannelTargetPrefix, r as createChatChannelPlugin, s as stripTargetKindPrefix, t as buildChannelOutboundSessionRoute } from "./core-D9rS5gM5.js";
import { n as describeAccountSnapshot } from "./account-helpers-Ywx_Aarz.js";
import { d as createTopLevelChannelConfigAdapter } from "./channel-config-helpers-BKuR4Cr5.js";
import { o as createPairingPrefixStripper } from "./channel-pairing-CMuqpAgA.js";
import { k as projectConfigWarningCollector, v as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-CZapjgwh.js";
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-nIDZwrs-.js";
import { i as buildProbeChannelStatusSummary, l as createComputedAccountStatusAdapter, u as createDefaultChannelRuntimeState } from "./status-helpers-CFGRcH-W.js";
...
import { a as listDirectoryEntriesFromSources } from "./directory-config-helpers-BEqrASIi.js";
...
import { t as formatAllowFromLowercase } from "./allow-from-E6eVZuju.js";
import { n as createMessageToolCardSchema } from "./channel-actions-CTdvMxrS.js";
import "./runtime-api-CQq5vBir.js";
import { t as MSTeamsChannelConfigSchema } from "./config-schema-BTNTLefy.js";
import { r as resolveMSTeamsGroupToolPolicy } from "./policy-Blby_tTe.js";
import { f as resolveMSTeamsCredentials } from "./graph-users-D5dp7JD_.js";
import { i as parseMSTeamsTeamChannelInput, n as normalizeMSTeamsUserInput, o as resolveMSTeamsChannelAllowlist, r as parseMSTeamsConversationId, s as resolveMSTeamsUserAllowlist, t as normalizeMSTeamsMessagingTarget } from "./resolve-allowlist-Dl-fEWLv.js";
...
const loadMSTeamsChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-C4umZXcF.js"), "msTeamsChannelRuntime");
...
const msteamsPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorMSTeamsProvider } = await import("./src-BXRbawPA.js");
