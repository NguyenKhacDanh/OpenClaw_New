...
import { _ as resolveJidToE164, d as isSelfChatMode, f as jidToE164, p as normalizeE164, w as toWhatsappJid } from "./utils-ChfYK_zu.js";
import { $F as resolveTextChunkLimit, BI as resolveMarkdownTableMode, Bj as formatInboundEnvelope, DM as recordChannelActivity, Dj as resolveInboundSessionEnvelopeContext, Fj as shouldComputeCommandAuthorized, GC as parseActivationCommand, Gb as createConnectedChannelStatusPatch, MI as resolveGroupSessionKey, Mj as hasControlCommand, Oj as formatLocationText, QF as resolveChunkMode, WC as normalizeGroupActivation, Xj as resolveInboundDebounceMs, Yj as createInboundDebouncer, aF as saveMediaBuffer, dN as recordSessionMetaFromInbound, f as loadConfig, fc as checkInboundAccessControl, fd as getReplyFromConfig, id as dispatchReplyWithBufferedBlockDispatcher, kj as toLocationContext, lN as loadSessionStore } from "./auth-profiles-Bx_pc0K9.js";
import { a as buildGroupHistoryKey, c as normalizeAgentId, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey } from "./session-key-B-JhgBEk.js";
import { a as shouldLogVerbose, n as info, o as success, r as logVerbose, t as danger } from "./globals-DcVoseYv.js";
import { r as logInfo } from "./logger-BxqoWWkC.js";
import { t as formatCliCommand } from "./command-format-CG2xBVG6.js";
import "./core-D9rS5gM5.js";
import { a as resolveAgentRoute, n as buildAgentSessionKey, o as resolveInboundLastRouteSessionKey, r as deriveLastRoutePolicy } from "./base-session-key-NgoBW9Up.js";
...
import { a as resolveDmGroupAccessWithCommandGate, c as resolvePinnedMainDmOwnerFromAllowlist, n as readStoreAllowFromForDmPolicy } from "./dm-policy-shared-D9Rt9w-c.js";
import "./routing-Bu83wHhI.js";
import { o as resolveIdentityNamePrefix, s as resolveMessagePrefix } from "./identity-CYcjYQwp.js";
import { l as resolveWhatsAppMediaMaxBytes, s as resolveWhatsAppAccount } from "./accounts-DtvLHbCP.js";
import { l as resolveStorePath } from "./paths-DMlxK0ei.js";
import { r as shouldAckReactionForWhatsApp } from "./ack-reactions-BiPKN1m8.js";
import { t as finalizeInboundContext } from "./inbound-context-Cm4_-Y_H.js";
import { r as enqueueSystemEvent } from "./system-events-Bwik0M7d.js";
import { n as resolveMentionGating } from "./text-chunking-KNP90Bp8.js";
import { c as getAgentScopedMediaLocalRoots } from "./web-media-BgsN6JmW.js";
import { p as resolveSendableOutboundReplyParts } from "./reply-payload-DjEdxZBw.js";
import { d as sleepWithAbort, u as computeBackoff } from "./runtime-env-Cl5OP7LB.js";
import { r as formatDurationPrecise } from "./format-duration-DnQHRp2B.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline-CxDxu1Px.js";
import { f as buildMentionRegexes, h as normalizeMentionText, r as buildHistoryContextFromEntries, u as recordPendingHistoryEntryIfEnabled } from "./reply-history-DgDnhohn.js";
import "./security-runtime-tuaxAQrW.js";
import { t as waitForever } from "./wait-b4b7oaHj.js";
import "./cli-runtime-W72eFMDQ.js";
import { _ as getSenderIdentity, c as readWebSelfId, f as getComparableIdentityValues, g as getSelfIdentity, h as getReplyContext, i as logoutWeb, l as readWebSelfIdentity, m as getPrimaryIdentityId, n as getWebAuthAgeMs, p as getMentionIdentities, v as identitiesOverlap, y as resolveComparableIdentity } from "./auth-store-U3gXL9vv.js";
import { i as setActiveWebListener } from "./active-listener-1qvLPfyD.js";
import { r as sendReactionWhatsApp } from "./send-DeE1xU9i.js";
import { n as getStatusCode, t as formatError } from "./session-errors-CR9f_522.js";
import { a as updateLastRouteInBackground, c as whatsappLog, d as resolveHeartbeatSeconds, f as resolveReconnectPolicy, i as trackBackgroundTask, l as whatsappOutboundLog, n as elide, o as whatsappHeartbeatLog, r as isLikelyWhatsAppCryptoError, s as whatsappInboundLog, t as deliverWebReply, u as newConnectionId } from "./deliver-reply-BorIXUYp.js";
import { a as waitForWaConnection, c as getContentType, d as DisconnectReason, i as waitForCredsSaveQueueWithTimeout, l as normalizeMessageContent, o as downloadMediaMessage, s as extractMessageContent, t as createWaSocket, u as isJidGroup } from "./session-DyuOev0u.js";
