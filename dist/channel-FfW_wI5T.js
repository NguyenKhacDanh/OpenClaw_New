import { GE as resolveMatrixAccount, HE as listMatrixAccountIds, KE as resolveMatrixAccountConfig, QE as resolveMatrixTargetIdentity, WE as resolveDefaultMatrixAccountId, XE as normalizeMatrixResolvableTarget, YE as normalizeMatrixMessagingTarget, ZE as resolveMatrixDirectUserId, _D as matrixSetupAdapter } from "./auth-profiles-CbvzvUuD.js";
import { g as DEFAULT_ACCOUNT_ID } from "./session-key-B-JhgBEk.js";
import { m as createScopedAccountReplyToModeResolver, o as stripChannelTargetPrefix, r as createChatChannelPlugin, s as stripTargetKindPrefix, t as buildChannelOutboundSessionRoute } from "./core-B0vcREeb.js";
import { c as GroupPolicySchema, m as MarkdownConfigSchema } from "./zod-schema.core-CKUw0Kgf.js";
import { i as buildNestedDmConfigSchema, r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-CRyTg0IK.js";
import { n as describeAccountSnapshot } from "./account-helpers-Ywx_Aarz.js";
import { c as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor, u as createScopedDmSecurityResolver } from "./channel-config-helpers-BKuR4Cr5.js";
import { o as createPairingPrefixStripper } from "./channel-pairing-CMuqpAgA.js";
import { E as projectAccountConfigWarningCollector, y as createAllowlistProviderOpenWarningCollector } from "./channel-policy-CZapjgwh.js";
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-nIDZwrs-.js";
import { i as buildProbeChannelStatusSummary, l as createComputedAccountStatusAdapter, s as collectStatusIssuesFromLastError, u as createDefaultChannelRuntimeState } from "./status-helpers-CFGRcH-W.js";
import { r as buildSecretInputSchema } from "./secret-input-CpodnrwQ.js";
import "./outbound-runtime--HFn5s1Z.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-NdIaS2U-.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-DkQr1PE5.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-BEqrASIi.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-kuh0tGDf.js";
import { d as readNumberParam, h as readStringParam, i as createActionGate } from "./common-BXGyoBih.js";
import { o as ToolPolicySchema } from "./zod-schema.agent-runtime-DZwW9Yaz.js";
import "./channel-config-schema-SQ9QhzBt.js";
import { d as requiresExplicitMatrixDefaultAccount } from "./storage-paths-BXK5P5fW.js";
import { t as zod_exports } from "./zod-C2BGnibp.js";
import "./channel-status-CVscRC6A.js";
import { r as buildTrafficStatusSummary } from "./extension-shared-DJe6TGN1.js";
import { i as resolveMatrixRoomConfig, n as normalizeMatrixUserId, t as normalizeMatrixAllowList } from "./allowlist-D-p9FD6D.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-C1C3aYSj.js");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CxU4aVou.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-Dkm5q0Gb.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
