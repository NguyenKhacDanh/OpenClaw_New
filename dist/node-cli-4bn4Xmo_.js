...
import { Ak as resolveExecApprovals, CA as unwrapKnownDispatchWrapperInvocation, DO as formatExecCommand, Dk as recordAllowlistUse, Ek as readExecApprovalsSnapshot, Fk as requestJsonlSocket, Gk as resolveAllowAlwaysPatterns, Gy as formatHelpExamples, Hk as evaluateShellAllowlist, Lk as isInterpreterLikeSafeBin, NO as normalizeSystemRunApprovalPlan, OO as resolveSystemRunCommandRequest, Pk as saveExecApprovals, SA as resolveInlineCommandMatch, Sk as normalizeExecApprovals, UC as getMachineDisplayName, Vk as evaluateExecAllowlist, Wb as resolveGatewayConnectionAuth, Xk as analyzeArgvCommand, _k as ensureExecApprovals, bA as unwrapKnownShellMultiplexerInvocation, bk as mergeExecApprovalsSocketDefaults, cv as runBrowserProxyCommand, dk as detectInterpreterInlineEvalArgv, f as loadConfig, fA as resolveCommandResolutionFromArgv, gk as addAllowlistEntry, ij as NODE_SYSTEM_RUN_COMMANDS, kk as requiresExecApproval, nA as resolvePlannedSegmentArgv, nj as NODE_BROWSER_PROXY_COMMAND, rj as NODE_EXEC_APPROVALS_COMMANDS, sy as resolveBrowserConfig, uA as resolveApprovalAuditCandidatePath, uk as describeInterpreterInlineEval, vA as resolveExecutableFromPathEnv, wA as normalizeExecutableToken, xA as POSIX_INLINE_COMMAND_FLAGS, yA as POSIX_SHELL_WRAPPERS, zk as resolveExecSafeBinRuntimePolicy } from "./auth-profiles-CbvzvUuD.js";
import { _ as resolveStateDir } from "./paths-DnMZ9c-4.js";
import { i as resolveAgentConfig } from "./agent-scope-Cb7ofJgr.js";
import { t as sameFileIdentity } from "./file-identity-B6zB1i8E.js";
import { a as logWarn } from "./logger-BxqoWWkC.js";
import { a as sanitizeHostExecEnv, s as sanitizeSystemRunEnvOverrides, t as inspectHostExecEnvOverrides } from "./host-env-security-BeGZP9n7.js";
import { n as VERSION } from "./version-DUAVxUwB.js";
import { t as formatCliCommand } from "./command-format-CG2xBVG6.js";
import { r as writeJsonAtomic } from "./json-files-Dzd4hAuk.js";
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES } from "./message-channel-BZJLUQ0u.js";
import { t as splitShellArgs } from "./shell-argv-BiUKCbjn.js";
import { n as loadOrCreateDeviceIdentity } from "./device-identity-DVlMCi3j.js";
import { u as GatewayClient } from "./method-scopes-CIu5ffF7.js";
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-D5gU0yVR.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-Bs4bTW6E.js";
import { c as buildNodeServiceEnvironment } from "./runtime-paths-DJtFCrQT.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DVTfAxiC.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-CHWBl6TP.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-CJlaMH6z.js";
import { t as parsePort } from "./parse-port-Df_dGUR3.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-Cw_4JWGz.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-3nrv5VNJ.js";
