...
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-ChfYK_zu.js";
import { Bk as resolveMergedSafeBinProfileFixtures, DI as isPrimarySessionTranscriptFileName, Ds as applyPluginAutoEnable, EI as formatSessionArchiveTimestamp, Es as resolvePluginProviders, Fh as analyzeBootstrapBudget, Go as resolveApiKeyForProvider, HO as buildGatewayConnectionDetails, IL as resolveNormalizedProviderModelMaxTokens, Ih as buildBootstrapInjectionStats, Jk as isTrustedSafeBinPath, LI as loadCronStore, LL as LEGACY_TALK_PROVIDER_ID, LP as loadModelCatalog, M as migrateLegacyConfig, PI as resolveConfiguredSecretInputWithFallback, RI as resolveCronStorePath, Rk as listInterpreterLikeSafeBins, Sw as resolveCommandSecretRefsViaGateway, UL as formatAuthDoctorHint, UO as callGateway, WS as inspectTelegramAccount, Xf as resolveProfileUnusableUntilForDisplay, Yk as normalizeTrustedSafeBinDirs, ZS as resolveTelegramAccount, aA as listRiskyConfiguredSafeBins, ay as resolveGoogleChromeExecutableForPlatform, cg as resolveActiveMemoryBackendConfig, fA as resolveCommandResolutionFromArgv, g as readConfigFileSnapshot, iy as readBrowserVersion, jS as lookupTelegramChatId, lN as loadSessionStore, mc as resolveAgentSessionDirs, nL as logConfigUpdated, ob as resolveGatewayAuth, qS as listTelegramAccountIds, qk as getTrustedSafeBinDirs, ry as parseBrowserMajorVersion, t as resolveApiKeyForProfile, tb as hasAmbiguousGatewayAuthModeConfig, tk as readGatewayTokenEnv, x as writeConfigFile, yg as resolveBootstrapContextForRun, zI as saveCronStore, zL as normalizeTalkSection } from "./auth-profiles-CbvzvUuD.js";
import { c as updateAuthProfileStoreWithLock, n as ensureAuthProfileStore } from "./store-hq9aamNS.js";
...
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-DnMZ9c-4.js";
import { T as parseAgentSessionKey, _ as normalizeAccountId, g as DEFAULT_ACCOUNT_ID, v as normalizeOptionalAccountId } from "./session-key-B-JhgBEk.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-Cb7ofJgr.js";
import { n as runCommandWithTimeout, r as runExec } from "./exec-DSvHEDD0.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-BofixiGI.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-CKFBC4zU.js";
import { _ as resolveHooksGmailModel, a as getModelRefStatus, h as resolveConfiguredModelRef } from "./model-selection-CcR6SGXw.js";
import { n as formatConfigIssueLines } from "./issue-format-CgDJvAeW.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-D6PgnNgv.js";
import { k as cleanStaleLockFiles } from "./docker-D2HX5e0L.js";
import { n as migrateLegacyWebSearchConfig } from "./legacy-web-search-XAvgHJMN.js";
import { C as formatSlackStreamingBooleanMigrationMessage, D as resolveSlackStreamingMode, E as resolveSlackNativeStreaming, O as resolveTelegramPreviewStreamMode, S as formatSlackStreamModeMigrationMessage, T as resolveDiscordPreviewStreamMode } from "./zod-schema.providers-core-BdjnVISd.js";
import { r as normalizeChatChannelId } from "./chat-meta-C7pBClla.js";
import "./registry-CYKflEtU.js";
import { i as normalizePluginId } from "./config-state-OikMaKr9.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-DqyqAJbg.js";
import { t as formatCliCommand } from "./command-format-CG2xBVG6.js";
import { i as listRouteBindings } from "./bindings-2LfKZOKA.js";
import { d as shouldMoveSingleAccountChannelKey } from "./setup-helpers-BCTVwbQ6.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-C4QstAv6.js";
import { s as parseToolsBySenderTypedKey } from "./channel-policy-CZapjgwh.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-D9Rt9w-c.js";
import { n as listChannelPlugins } from "./plugins-BNOJE4r3.js";
import { a as readChannelAllowFromStore } from "./pairing-store-L_-z3h2o.js";
import { i as formatSetExplicitDefaultToConfiguredInstruction, n as formatChannelAccountsDefaultPath, r as formatSetExplicitDefaultInstruction } from "./routing-Bu83wHhI.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-DMlxK0ei.js";
import { t as describeUnknownError } from "./shared-DeBmfqWx.js";
import { i as resolveMainSessionKey } from "./main-session-VO-PbcmU.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BRuaXbHY.js";
import { $ as resolveBootstrapTotalMaxChars, Z as resolveBootstrapMaxChars } from "./reply-payloads-dedupe-DmrsC7on.js";
import { l as DEFAULT_SANDBOX_IMAGE, r as resolveSandboxScope, s as DEFAULT_SANDBOX_BROWSER_IMAGE } from "./config-TAMTTY0L.js";
import "./logging-CPV8MAfG.js";
import { a as isWSL, s as isWSLEnv } from "./runtime-env-Cl5OP7LB.js";
import { d as resolveGatewayBindHost, r as isLoopbackHost } from "./net-Dsx1u6X4.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-Ltvb3Tsc.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-D5gU0yVR.js";
import { a as repairOAuthProfileIdMismatch } from "./provider-auth-DKqU4ksq.js";
import { n as normalizeTelegramAllowFromEntry, t as isNumericTelegramUserId } from "./allow-from-TcNWJnyW.js";
import { a as inspectPortUsage, c as formatPortDiagnostics } from "./ports-CrHMbdrx.js";
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-8xA2DjGw.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-DJtFCrQT.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-BzQBjf8b.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DVTfAxiC.js";
import { a as guardCancel, d as randomToken, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-Dp8_asbY.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-C7Uz_3ig.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-DTYsi3pu.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-h-zaSjS4.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-BI9JBLd7.js";
...
import { t as readLastGatewayErrorLine } from "./diagnostics-NeeU1tMc.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-CgsFsjO0.js";
import { _ as DEFAULT_GOOGLE_API_BASE_URL } from "./memory-core-host-engine-embeddings-RsIT1m-1.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-mImzI7_i.js";
import { i as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, r as getBuiltinMemoryEmbeddingProviderDoctorMetadata } from "./manager-TUV62iLp.js";
import "./memory-core-engine-runtime-Yjuc09eV.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DlhJCs1g.js";
import { a as buildPluginStatusReport, r as buildPluginCompatibilityWarnings } from "./status-CKpDZg_y.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-lNhhV-Jg.js";
import { t as note$1 } from "./note-BCZGGxvP.js";
import { r as resolveBundledPluginSources } from "./bundled-sources-CuLbyDg3.js";
import { r as healthCommand } from "./health-Cz1mEGW3.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DEFZw5Xd.js";
import { g as normalizeStoredCronJobs, n as runGatewayUpdate, t as runStartupMatrixMigration } from "./server-startup-matrix-migration-BbKykcVk.js";
import { n as runMatrixDoctorSequence, t as cleanStaleMatrixPluginConfig } from "./matrix-ie381RxU.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-CFVnVfFQ.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DQU4qhsQ.js";
import { t as formatHealthCheckFailure } from "./health-format-DwTOqqyN.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-CXj-MK92.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-D6qRte9I.js";
import { n as doctorShellCompletion } from "./doctor-completion-4dQyXKb2.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-cHRQ4ms8.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-DyGhhalb.js";
import { i as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./doctor-state-migrations-tB-6anR8.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-C8ZGkAIf.js";
