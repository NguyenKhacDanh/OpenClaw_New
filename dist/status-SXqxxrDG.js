...
import { ZO as isGatewaySecretRefUnavailableError, l as createConfigIO, nk as trimToUndefined, rk as loadGatewayTlsRuntime } from "./auth-profiles-Bx_pc0K9.js";
...
import { _ as inspectBestEffortPrimaryTailnetIPv4, f as resolveControlUiLinks, y as resolveBestEffortGatewayBindHostForDisplay } from "./onboard-helpers-DU-QKVxu.js";
...
import { i as resolveGatewayProbeAuthWithSecretInputs } from "./probe-auth-z9MES5va.js";
...
async function probeGatewayStatus(opts) {
	try {
		const result = await withProgress({
			...
			if (opts.requireRpc) {
				const { callGateway } = await import("./call-D2ziaT04.js");
				await callGateway({
					url: opts.url,
					token: opts.token,
			...
			const { probeGateway } = await import("./probe-BsBtkjyp.js");
