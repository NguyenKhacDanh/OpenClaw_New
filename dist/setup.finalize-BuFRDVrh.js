...
import { Fp as listConfiguredWebSearchProviders } from "./auth-profiles-Bx_pc0K9.js";
...
import { f as resolveControlUiLinks, g as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-DU-QKVxu.js";
...
import { t as runTui } from "./tui-zKv0It7o.js";
...
async function finalizeSetupWizard(options) {
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-ReDR-WPd.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-ReDR-WPd.js");
